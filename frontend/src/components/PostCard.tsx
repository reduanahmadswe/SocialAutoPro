...
export default function PostCard({ post, onRetry, onDelete, onViewLogs }: PostCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 sm:p-5 hover:shadow-md transition-shadow duration-200 animate-fade-in flex flex-col">
        ...
        <div className="flex-1 min-w-0">
          ...
          {post.image_url && (
            <div className="flex items-center gap-1.5 text-xs text-slate-400 mb-2">
              ...
              <span className="truncate">{post.image_url}</span>
            </div>
          )}
